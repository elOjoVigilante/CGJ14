...
public var punish:boolean = false;
...
var funcCall:String = "getCoin";
var score = GameObject.Find("Score");
score.BroadcastMessage("changeBg",Color.white, SendMessageOptions.DontRequireReceiver);

if(punish) 
  funcCall = "getPrize";

score.BroadcastMessage(funcCall,1,SendMessageOptions.DontRequireReceiver);
